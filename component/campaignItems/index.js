...
const CampaignItems = ({ name, description, color, icon }) => {
  return (
    <div className={`!h-[246px] w-[254px] border bg-white border-[#C4C4C7] mx-auto rounded-[4px] hover:bg-[#F2F0F4]`}>
      <div className="flex flex-col items-center justify-center w-full h-full ">
        <div className="p-2 rounded-[8px] h-[100px] w-[88px] flex items-center justify-center" style={{
        ...
        <h3 className="text-center text-[#DC3545] text-[20px] py-4">{name.length > 12 ? `${name.slice(0,12)}...`:name}</h3>
